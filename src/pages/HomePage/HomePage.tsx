...
function HomePage() {
    ...
    return (
        <div className="flex">
            ...
            <div className="hidden lg:block w-1/4 h-screen sticky top-14 bg-blue-50 p-4 shadow-md overflow-y-auto">
            ...
            {/* Product Listing */}
            <div className="flex-1 py-10 flex flex-wrap justify-center gap-4 overflow-y-auto h-screen">
                {loading ? (
